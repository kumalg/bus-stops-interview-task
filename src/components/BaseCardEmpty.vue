<template>
  <div ref="cardEl" class="empty-card-container">
    <BaseCard class="empty-card">
      <svg class="svg" :width="svgSize.width" :height="svgSize.height" :view-box="`-2 -2 ${svgSize.height} ${svgSize.width}`" xmlns="http://www.w3.org/2000/svg" >
        <rect class="svg-rect" x="1" y="1" rx="4" ry="4" fill="transparent" :width="cardSize.width" :height="cardSize.height" stroke-width="2px" stroke-dasharray="25 30" stroke-linecap="round" />
      </svg>
